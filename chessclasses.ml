...
game#print;;
game#turn;;
game#get_moves false;;
let l = game#moves;;
let l = [Dep ((5, 7), (2, 4)); Dep ((6, 0), (7, 2)); Dep ((0, 6), (0, 5));
 Dep ((2, 1), (2, 3)); Dep ((4, 6), (4, 4)); Dep ((1, 1), (1, 3))];;
List.iter game#move_piece l;;
game#print;;
game#mouvements_p (4,0) King false;;
